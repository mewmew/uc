...
Identifiers are resolved by searching for their corresponding declarations starting from the current (i.e. nearest) scope, and successivly searching outer scopes, until either the closest declaration is located or the outermost scope has been reached.
...
Type deduction of expressions are carried out The types of expressions are deduced through a

Secondly, the bodies of global definitions are traversed top-down and left-to-right to resolve identifiers and deduce the types of expressions.
